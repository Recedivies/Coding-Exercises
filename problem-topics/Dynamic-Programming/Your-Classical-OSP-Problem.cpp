/*
 * Author : recedivies
 * Problem Link : https://tlx.toki.id/problems/joints-2019-pcs-semifinal/E
 * Mei 30, 2021
 */
#include <bits/stdc++.h>
using namespace std; 
...
int main() {
	...
	w.push_back({n, m});
	sort(w.begin(), w.end(), [](const pair<int, int> &x, const pair<int, int> &y) {
		return x.first + x.second < y.first + y.second;
	});
	dp[1][1] = 1;
	int curR = 1, curC = 1, prev = 1;
