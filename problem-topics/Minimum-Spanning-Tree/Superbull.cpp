/*
 * Author : recedivies
 * Problem Link : http://www.usaco.org/index.php?page=viewproblem2&cpid=531
 * Des 15, 2021
 */
#include <bits/stdc++.h>
using namespace std;
...
bool cmp(const edge& self, const edge& other){
