...
* 2 3 2
({1 = 1}, {2 = 2})
we need to find a[i] = b[c[i]]
(B[c[i]] = b[2] ~ 1, b[3] ~ 2, b[2] ~ 1, 
we have map a, if a[b[c]] ada then that's satisfy the condition above we need to find, 
if (a[1] ada then ans += a[1], and so on . . .)
*/
